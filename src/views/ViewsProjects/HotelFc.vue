      ...
      <div class="content">
        ...
        <div class="details">
          <div class="content-details">
            <h1 class="title-projects">HOTEL FC.BANANAL, SÃO PAULO</h1>
            <ul>
              <li><i class="fa-solid fa-people-group icon"></i>Arquitetos: <spam class="destaque">IFrancisco Cunha</spam> </li>
